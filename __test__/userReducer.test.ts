...
describe('Тестирование userReducer', () => {
  describe('Асинхронная функция регистрации', () => {
    ...
    test('Успешный запрос: register.fulfilled', () => {
      const state = reducer(
        userInitialState,
  ...
  describe('Асинхронная функция для входа в аккаунт: login', () => {
    ...
    test('Успешный запрос: login.fulfilled', () => {
      const state = reducer(
        userInitialState,
  ...
  describe('Асинхронная функция проверки авторизации: fetchUser', () => {
    test('Успешный запрос: fetchUser.fulfilled', () => {
      const state = reducer(
        userInitialState,
  ...
  describe('Асинхронная функция редактирования информации пользователя: updateUser', () => {
    test('Успешный запрос: updateUser.fulfilled', () => {
      const state = reducer(
        userInitialState,
